...
public class consultaUsuarioServlet extends HttpServlet {
	...
	public XMLGregorianCalendar convertLocalDateToXMLGregorianCalendar(LocalDate localDate) {
	    try {
	...
	public String convertXMLGregorianCalendarToString(XMLGregorianCalendar xmlGregorianCalendar, String pattern) {
